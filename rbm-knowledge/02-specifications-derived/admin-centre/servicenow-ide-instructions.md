...
This document defines the **mandatory ServiceNow IDE execution instructions** for building the Admin Centre feature using the approved **v2.02 Build Agent prompt pack**.
...
- **Admin-Center-Build-Agent-Prompt-Pack-v2.02**
