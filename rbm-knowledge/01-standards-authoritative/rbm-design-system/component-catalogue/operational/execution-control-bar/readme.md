# ExecutionControlBar — RBM Reference Component (Self-contained folder)

## Includes
- Component source under `src/`
- Token + density + base CSS under `tokens/` and `styles/`
- All direct dependencies (RBM reference implementations) required by `ExecutionControlBar`
