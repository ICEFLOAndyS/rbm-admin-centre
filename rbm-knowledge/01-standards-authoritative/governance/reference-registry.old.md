...
### 2.2 set-folder-segmentation — Feature shared pack
Applies to: Orchestrator when Folder Segmentation work is in scope

Includes:
1. ref-fs-consolidated
2. ref-fs-arch-dm
3. ref-fs-acl-matrix
4. ref-fs-build-pack
...
1. **ref-ide-exec-playbook** — ServiceNow IDE Prompt Execution Playbook  
   - type: internal  
   - path: `01-standards-authoritative/governance/playbooks/servicenow-ide-prompt-execution-playbook.md`  
   - version-context: v1.x  
   - tags: common, tooling  
   - status: active
...
1. **ref-fs-consolidated** — Folder Segmentation Consolidated Pack  
   - type: internal  
   - path: `02-specifications-derived/features/folder-segmentation/folder-segmentation-consolidated-pack.md`  
   - version-context: v1.x  
   - tags: folder-segmentation, features  
   - status: active

2. **ref-fs-arch-dm** — Folder Segmentation Architecture and Data Model  
   - type: internal  
   - path: `02-specifications-derived/features/folder-segmentation/folder-segmentation-architecture-and-data-model.md`  
   - version-context: v1.x  
   - tags: folder-segmentation, architecture  
   - status: active

3. **ref-fs-acl-matrix** — Folder Segmentation ACL Matrix  
   - type: internal  
   - path: `02-specifications-derived/features/folder-segmentation/folder-segmentation-acl-matrix.md`  
   - version-context: v1.x  
   - tags: folder-segmentation, security  
   - status: active

4. **ref-fs-build-pack** — Folder Segmentation Build Agent Notes  
   - type: internal  
   - path: `02-specifications-derived/features/folder-segmentation/folder-segmentation-build-agent-prompt-pack.md`  
   - version-context: v1.x  
   - tags: folder-segmentation, tooling  
   - status: active
...
18. **ref-ext-flow-designer-overview** — Flow Designer Overview  
    - type: external  
...
19. **ref-ext-flows-getting-started** — Getting Started with Flows  
    - type: external  
...
20. **ref-ext-flow-designer-reference** — Flow Designer Reference  
    - type: external  
...
21. **ref-ext-gliderecord-api-scoped** — GlideRecord API (Scoped applications)  
    - type: external  
...
22. **ref-ext-querying-tables** — Querying Tables in Scripts  
    - type: external  
...
23. **ref-ext-atf-intro** — Introduction to Automated Test Framework  
    - type: external  
...
24. **ref-ext-atf-design-considerations** — ATF Design Considerations  
    - type: external  
...
25. **ref-ext-atf-first-test** — Build and Run Your First Automated Test  
    - type: external  
...
26. **ref-ext-pa-landing** — Performance Analytics (Landing Page)  
    - type: external  
...
27. **ref-ext-pa-getting-started** — Explore Performance Analytics  
    - type: external  
...
28. **ref-ext-servicenow-ms-teams** — ServiceNow for Microsoft Teams and Microsoft 365  
    - type: external  
