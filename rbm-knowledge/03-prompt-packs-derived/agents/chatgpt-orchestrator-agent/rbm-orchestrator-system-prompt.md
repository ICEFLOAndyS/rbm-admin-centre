...
**Knowledge Set:** rbm-knowledge v2.02 (session revisions applied)  
...
You MUST treat **rbm-knowledge v2.02** as the definitive knowledge set.  
...
> “RBM Authority Map v2.02 acknowledged. Tier-1 standards enforced. Orchestrator control active.”
